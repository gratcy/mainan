...
exports.get_order_detail_approved = function(conn, type, id) {
    ...
    conn.getConnection(function(err, connection){
		if (type == 1)
			...
			var query_str = 'SELECT a.tqty,a.tprice,a.tpricebase,a.ttype,b.pcode,b.pname,b.pdesc,b.ppricedozen,pkoliqty,c.cname FROM transaction_detail_tab a INNER JOIN products_tab b ON a.tpid=b.pid JOIN categories_tab c ON b.pcid=c.cid WHERE a.ttid = ? AND a.tstatus=1 AND b.pstatus=1 ORDER BY b.pid DESC';
